...
\NormalTok{  testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\KeywordTok{file.path}\NormalTok{(folder_name, }\StringTok{"1"}\NormalTok{, }\StringTok{"parameters.csv"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\NormalTok{parameters_filenames)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\KeywordTok{file.path}\NormalTok{(folder_name, }\StringTok{"1"}\NormalTok{, }\StringTok{"mbd.tree"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\NormalTok{input_filenames)}
    \CommentTok{# True MBD alignment}
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\KeywordTok{file.path}\NormalTok{(folder_name, }\StringTok{"1"}\NormalTok{, }\StringTok{"mbd.fasta"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\NormalTok{input_filenames)}
    \CommentTok{# Twin BD tree}
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\KeywordTok{file.path}\NormalTok{(folder_name, }\StringTok{"1"}\NormalTok{, }\StringTok{"bd.tree"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\NormalTok{input_filenames)}
    \CommentTok{# Twin BD alignment}
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\KeywordTok{file.path}\NormalTok{(folder_name, }\StringTok{"1"}\NormalTok{, }\StringTok{"bd.fasta"}\NormalTok{) }\OperatorTok{%in%}\StringTok{ }\NormalTok{input_filenames)}
\NormalTok{  \}}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\StringTok{"1a.trees"} \OperatorTok{%in%}\StringTok{ }\NormalTok{output_filenames)}
    \CommentTok{# Trace of MCMC, to estimate the Effective Sample Sizes}
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\StringTok{"1a.log"} \OperatorTok{%in%}\StringTok{ }\NormalTok{output_filenames)}
    \CommentTok{# Marginal likelihood}
\NormalTok{    testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\StringTok{"1a_mar_lik.csv"} \OperatorTok{%in%}\StringTok{ }\NormalTok{output_filenames)}
\NormalTok{  \}}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{      testit}\OperatorTok{::}\KeywordTok{assert}\NormalTok{(}\StringTok{"1a_nltts.csv"} \OperatorTok{%in%}\StringTok{ }\NormalTok{nltt_filename)}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}
