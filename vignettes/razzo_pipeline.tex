...
\includegraphics{razzo_pipeline_files/figure-latex/unnamed-chunk-6-1.pdf}
...
\NormalTok{  \{}
\NormalTok{    output_filenames <-}\StringTok{ }\KeywordTok{raz_create_posterior_files}\NormalTok{(fasta_filename)}
