...
```{r}
mbd_estimates <- tracerer::parse_beast_log(mbd_alignment_filenames[[1]][2])
sample_interval <- raz_open_parameters_file(parameters_filename[1])$sample_interval
mbd_esses <- tracerer::calc_esses(
  traces = mbd_estimates, 
  sample_interval = sample_interval 
)
knitr::kable(mbd_esses)
```
