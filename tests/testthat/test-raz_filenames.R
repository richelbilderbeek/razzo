...
test_that("use", {
  ...
  bd_tree_filename   <- razzo::raz_create_filename_bd_tree(
    parameters = parameters, folder_name = folder_name)
  mbd_fasta_filename <- razzo::raz_create_filename_mbd_alignment(
    parameters = parameters, folder_name = folder_name)
  bd_fasta_filename  <- razzo::raz_create_filename_bd_alignment(
    parameters = parameters, folder_name = folder_name)
  ...
  parameters_path <- razzo::raz_get_parameters_path(
    parameters = parameters, folder_name = folder_name
  )
