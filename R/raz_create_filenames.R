...
#' @export
raz_create_filename_mbd_tree <- function( # nolint internal function
  parameters,
  folder_name
) {
...
#' @author Richel J.C. Bilderbeek, Giovanni Laudanno
#' @export
raz_create_filename_bd_tree <- function( # nolint internal function
  parameters,
  folder_name
) {
  parameters_folder <- razzo::raz_get_parameters_path(
...
#' @author Richel J.C. Bilderbeek, Giovanni Laudanno
#' @export
raz_create_filename_mbd_alignment <- function( # nolint internal function
  parameters,
  folder_name
) {
  parameters_folder <- razzo::raz_get_parameters_path(
...
#' @author Richel J.C. Bilderbeek, Giovanni Laudanno
#' @export
raz_create_filename_bd_alignment <- function( # nolint internal function
  parameters,
  folder_name
) {
  parameters_folder <- razzo::raz_get_parameters_path(
